module Puppet::Parser::Functions 
  newfunction(:ssh_entries, :type => :rvalue) do |args|
    raise Puppet::Error, "Must provide exactly four arguments"                                               unless args.count == 5
    ...
    args[0].reduce({}) do |acc,el|  
      acc[%Q{#{args[2]}!#{el[1]}@#{el[0]}}] = { 'hostname' => el[0], 'identity' => args[1], 'sshname' => args[2], 'forward_agent' => args[3], 'port' => args[4]}
